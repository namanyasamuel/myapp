...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    @if (Route::has('login'))
        ...
        <div class="p-10 text-right z-10">
            ...
            @else
                <a href="{{ route('login') }}" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"> LabTech Login</a>
    ...
    @endif
        ...
        <h1 class="text-4xl  text-gray-900 font-extrabold text-center mt-2">Friecca Pharmacy Laboratory Management System</h1>
                ...
                <div class=" mt-6 ">
                <div class="flex justify-center w-full gap-8 lg:gap-15">
    <a href="https://laravel.com/docs" class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500 flex-1">
