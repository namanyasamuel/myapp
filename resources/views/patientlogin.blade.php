          ...
          <form action="{{ route( 'patientlogin' ) }}" method="POST">
           @csrf
            ...
            <label for="inputEmail">Email address or Surname </label>
             <input type="text" class="form-control " id="inputEmail" name="email_or_surname" placeholder="Enter email address" required style="border-radius:20px">
            </div>
            <div class="form-group p-3">
             <label for="inputPassword"> Telephone Number</label>
             <input type="text" class="form-control text-justify " id="inputPassword" name="telephone_number" placeholder=" Enter Password" required style="border-radius:20px">
            </div>
            <div>
